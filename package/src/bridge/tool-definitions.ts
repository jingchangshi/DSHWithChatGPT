...
export const WORKSPACE_TOOL_DEFINITIONS = {
  ...
  git_diff: { name: 'git_diff', description: 'Read a bounded diff against HEAD, upstream, or a lowercase 7–64 digit commit SHA.', inputSchema: object({ against_ref: string, max_bytes: number }) },
